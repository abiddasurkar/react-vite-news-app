...
export default function Login() {
    ...
    const handleChange = (e) => {
        ...
        console.log(`Input changed: ${name} = ${value}`) // <-- added
        setFormData((prev) => ({
            ...prev,
            [name]: value,
        }))
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        console.log('Form submitted', formData) // <-- added
        setLoading(true)

        if (!formData.email || !formData.password || !formData.fullName) {
            setError('All fields are required')
            console.log('Validation error: All fields required') // <-- added
            setLoading(false)
            return
        }
        ...
        if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(formData.email)) {
            ...
            console.log('Validation error: Invalid email') // <-- added
            setLoading(false)
            return
        }
        ...
        if (formData.password.length < 6) {
            ...
            console.log('Validation error: Password too short') // <-- added
            setLoading(false)
            return
        }
        ...
        setTimeout(() => {
            ...
            console.log('Saving login data', loginData) // <-- added
            ...
            console.log('Navigation to /news') // <-- added
            navigate('/news')
        }, 800)
    }
