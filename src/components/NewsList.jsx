  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: THEME.colors.stone[50] }}>
      ...
      <header 
        ...
        style={{ backgroundColor: 'white', borderColor: THEME.colors.stone[200] }}
      >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 
                  ...
                  style={{ fontFamily: THEME.typography.display.family, color: THEME.colors.red[900] }}
                >
                  Unable to Load News
                </h3>
                <p 
                  className="text-sm"
                  style={{ fontFamily: THEME.typography.body.family, color: THEME.colors.red[700] }}
                >
                  {error}
                </p>
              </div>
        ...
        {articles.length > 0 ? (
            ...
            <div ref={observerTarget} className="text-center py-12">
              {hasMore && loading ? (
                <div className="flex flex-col items-center gap-4">
                  <LoadingDots />
                  <p className="text-sm font-medium" style={{ fontFamily: THEME.typography.body.family, color: THEME.colors.stone[600] }}>
                ...
                <div className="py-10">
                  ...
                  <p className="text-xl font-bold mb-2" style={{ fontFamily: THEME.typography.display.family, color: THEME.colors.stone[900] }}>
                    That's all for now
                  </p>
                  <p className="text-sm" style={{ fontFamily: THEME.typography.body.family, color: THEME.colors.stone[600] }}>
          ...
          <div className="flex justify-center py-20">
            <div className="text-center">
              ...
              <p className="text-base font-medium" style={{ fontFamily: THEME.typography.body.family, color: THEME.colors.stone[600] }}>
          ...
          <div className="text-center py-20">
            ...
            <h3 className="text-3xl font-bold mb-3" style={{ fontFamily: THEME.typography.display.family, color: THEME.colors.stone[900] }}>
              No articles found
            </h3>
            <p className="text-lg mb-8 max-w-md mx-auto" style={{ fontFamily: THEME.typography.body.family, color: THEME.colors.stone[600] }}>
            ...
            <button
              ...
              style={{ fontFamily: THEME.typography.body.family, background: THEME.gradients.primary, color: 'white' }}
            >
              Reset Filters
            </button>
          </div>
